...
<body class="antialiased font-Poppin bg-gray-300">
    ...
    <section class=" bg-gray-100">
        ...
        <div id="KamarDisplay" class="-mt-18 px-16">

            @php
                $isSearching = request('tgl_checkin') || request('tgl_checkout') || request('tipe_kamar') || request('kapasitas');
            @endphp

            @if ($isSearching)
                        <h1 class="text-3xl font-poppin font-bold">Hasil Pencarian</h1>
                        @livewire('kamar-cari-display', [
    ...
    <section id="kamar">
        <div class="bg-white w-full pt-16">
            ...
            @livewire('kamar-display', ['jumlah_display' => 1, 'rekomendasi' => 'nonaktif'])
        </div>
    </section>
